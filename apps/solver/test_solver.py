...
from solver import AIIntegrationHelper, ConstraintSolver, RulesEngine, SolverConfig
...
class TestRulesEngine:
    ...
    def test_unknown_rule_handling(self):
        ...
        assert checks[0].passed  # Unknown rules default to passing
...
class TestAIIntegrationHelper:
    ...
    def test_format_response_for_backend(self):
        ...
        checks = [ComplianceCheck(rule_key="no-collision", passed=True, message="OK")]
...
class TestSolverConfig:
    ...
    def test_custom_config(self):
        ...
        config = SolverConfig(
            max_iterations=2000, timeout_seconds=60, optimization_level="optimal"
        )
