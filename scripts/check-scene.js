...
async function checkScene() {
  ...
  try {
    ...
    console.log('Project Categories Count:', scene?.project?.projectCategories?.length || 0);
    console.log('Project Categories:', JSON.stringify(scene?.project?.projectCategories || [], null, 2));
