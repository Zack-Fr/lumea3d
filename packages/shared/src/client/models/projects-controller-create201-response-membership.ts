 ...
 * 
 * @export
 * @interface ProjectsControllerCreate201ResponseMembership
 */
export interface ProjectsControllerCreate201ResponseMembership {
    /**
     * 
     * @type {string}
     * @memberof ProjectsControllerCreate201ResponseMembership
     */
    'userId'?: string;
    /**
     * 
     ...
     * @memberof ProjectsControllerCreate201ResponseMembership
     */
    'role'?: ProjectsControllerCreate201ResponseMembershipRoleEnum;
}

export const ProjectsControllerCreate201ResponseMembershipRoleEnum = {
    Client: 'CLIENT',
    Designer: 'DESIGNER',
    Admin: 'ADMIN'
} as const;

export type ProjectsControllerCreate201ResponseMembershipRoleEnum = typeof ProjectsControllerCreate201ResponseMembershipRoleEnum[keyof typeof ProjectsControllerCreate201ResponseMembershipRoleEnum];
