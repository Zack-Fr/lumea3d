 ...
 * 
 * @export
 * @interface ProjectsControllerCreate201ResponseProject
 */
export interface ProjectsControllerCreate201ResponseProject {
    /**
     * 
     * @type {string}
     * @memberof ProjectsControllerCreate201ResponseProject
     */
    'id'?: string;
    /**
     * 
