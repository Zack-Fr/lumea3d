 ...
 * 
 * @export
 * @interface ProjectsControllerCreate201ResponseScene
 */
export interface ProjectsControllerCreate201ResponseScene {
    /**
     * 
     * @type {string}
     * @memberof ProjectsControllerCreate201ResponseScene
     */
    'id'?: string;
    /**
     * 
