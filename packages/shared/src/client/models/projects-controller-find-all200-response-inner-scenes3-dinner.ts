 ...
 * 
 * @export
 * @interface ProjectsControllerFindAll200ResponseInnerScenes3DInner
 */
export interface ProjectsControllerFindAll200ResponseInnerScenes3DInner {
    /**
     * 
     * @type {string}
     * @memberof ProjectsControllerFindAll200ResponseInnerScenes3DInner
     */
    'id'?: string;
    /**
     * 
