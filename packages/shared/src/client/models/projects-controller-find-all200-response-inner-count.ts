 ...
 * 
 * @export
 * @interface ProjectsControllerFindAll200ResponseInnerCount
 */
export interface ProjectsControllerFindAll200ResponseInnerCount {
    /**
     * 
     * @type {number}
     * @memberof ProjectsControllerFindAll200ResponseInnerCount
     */
    'members'?: number;
}
