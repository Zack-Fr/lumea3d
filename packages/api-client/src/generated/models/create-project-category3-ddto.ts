 ...
 * 
 * @export
 * @interface CreateProjectCategory3DDto
 */
export interface CreateProjectCategory3DDto {
    /**
     * Asset ID to associate with the project category
     * @type {string}
     * @memberof CreateProjectCategory3DDto
     */
    'assetId': string;
    /**
     * Category key for organizing assets within the project
     * @type {string}
     * @memberof CreateProjectCategory3DDto
     */
    'categoryKey': string;
    /**
     * Enable GPU instancing for this asset category
     * @type {boolean}
     * @memberof CreateProjectCategory3DDto
     */
    'instancing'?: boolean;
    /**
     * Enable Draco compression for this asset category
     * @type {boolean}
     * @memberof CreateProjectCategory3DDto
     */
    'draco'?: boolean;
    /**
     * Enable MeshOpt compression for this asset category
     * @type {boolean}
     * @memberof CreateProjectCategory3DDto
     */
    'meshopt'?: boolean;
    /**
     * Enable KTX2 texture compression for this asset category
     * @type {boolean}
     * @memberof CreateProjectCategory3DDto
     */
    'ktx2'?: boolean;
