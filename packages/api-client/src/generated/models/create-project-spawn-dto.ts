 ...
 * 
 * @export
 * @interface CreateProjectSpawnDto
 */
export interface CreateProjectSpawnDto {
    /**
     * Spawn position [x, y, z] in world coordinates
     * @type {Array<number>}
     * @memberof CreateProjectSpawnDto
     */
    'position'?: Array<number>;
    /**
     * Spawn yaw rotation in degrees
     * @type {number}
     * @memberof CreateProjectSpawnDto
     */
    'yaw_deg'?: number;
