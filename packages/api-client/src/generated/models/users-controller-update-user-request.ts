 ...
 * 
 * @export
 * @interface UsersControllerUpdateUserRequest
 */
export interface UsersControllerUpdateUserRequest {
    /**
     * 
     * @type {string}
     * @memberof UsersControllerUpdateUserRequest
     */
    'email'?: string;
    /**
     * 
     ...
     * @memberof UsersControllerUpdateUserRequest
     */
    'role'?: UsersControllerUpdateUserRequestRoleEnum;
    /**
     * 
     * @type {boolean}
     * @memberof UsersControllerUpdateUserRequest
...
export const UsersControllerUpdateUserRequestRoleEnum = {
    Guest: 'GUEST',
    Client: 'CLIENT',
    Designer: 'DESIGNER',
    Admin: 'ADMIN'
...
export type UsersControllerUpdateUserRequestRoleEnum = typeof UsersControllerUpdateUserRequestRoleEnum[keyof typeof UsersControllerUpdateUserRequestRoleEnum];
