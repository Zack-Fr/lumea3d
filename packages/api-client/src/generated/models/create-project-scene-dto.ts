...
// @ts-ignore
import type { CreateProjectSpawnDto } from './create-project-spawn-dto';

/**
 * 
 * @export
 * @interface CreateProjectSceneDto
 */
export interface CreateProjectSceneDto {
    /**
     * Initial scene name
     * @type {string}
     * @memberof CreateProjectSceneDto
     */
    'name'?: string;
    /**
     * Spawn configuration for the initial scene
