...
// @ts-ignore
import type { FlatScenesControllerGetSceneCategories200ResponseCategoriesInnerCapabilities } from './flat-scenes-controller-get-scene-categories200-response-categories-inner-capabilities';

/**
 * 
 * @export
 * @interface FlatScenesControllerGetSceneCategories200ResponseCategoriesInner
 */
export interface FlatScenesControllerGetSceneCategories200ResponseCategoriesInner {
    /**
     * 
     * @type {string}
     * @memberof FlatScenesControllerGetSceneCategories200ResponseCategoriesInner
     */
    'categoryKey'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {FlatScenesControllerGetSceneCategories200ResponseCategoriesInnerCapabilities}
     * @memberof FlatScenesControllerGetSceneCategories200ResponseCategoriesInner
     */
    'capabilities'?: FlatScenesControllerGetSceneCategories200ResponseCategoriesInnerCapabilities;
}
