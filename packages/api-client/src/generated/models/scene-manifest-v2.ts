 ...
 * 
 * @export
 * @interface SceneManifestV2
 */
export interface SceneManifestV2 {
    /**
     * Scene metadata
     * @type {object}
     * @memberof SceneManifestV2
     */
    'scene': object;
    /**
     * Scene items with transforms and materials
     * @type {Array<string>}
     * @memberof SceneManifestV2
     */
    'items': Array<string>;
    /**
     * Asset categories referenced in the scene with enhanced metadata support
     * @type {object}
     * @memberof SceneManifestV2
     */
    'categories': object;
