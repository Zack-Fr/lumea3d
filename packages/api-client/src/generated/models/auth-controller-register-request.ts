...
export interface AuthControllerRegisterRequest {
     ...
     * @memberof AuthControllerRegisterRequest
     */
    'role'?: AuthControllerRegisterRequestRoleEnum;
}

export const AuthControllerRegisterRequestRoleEnum = {
    Guest: 'GUEST',
    Client: 'CLIENT',
    Designer: 'DESIGNER',
    Admin: 'ADMIN'
...
export type AuthControllerRegisterRequestRoleEnum = typeof AuthControllerRegisterRequestRoleEnum[keyof typeof AuthControllerRegisterRequestRoleEnum];
