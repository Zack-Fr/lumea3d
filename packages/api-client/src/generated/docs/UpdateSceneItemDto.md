...
------------ | ------------- | ------------- | -------------
**categoryKey** | **string** | Category key referencing project assets | [optional] [default to undefined]
...
```typescript
import { UpdateSceneItemDto } from './api';

const instance: UpdateSceneItemDto = {
    categoryKey,
    model,
    positionX,
    positionY,
